...
pub const TabController = controller.TabController;
pub const WorkspaceController = controller.WorkspaceController;
...
pub const RoutedSpawnedPanel = controller.WorkspaceController.SpawnedMarblesPanel;
pub const SpawnedPanel = controller.WorkspaceController.SpawnedMarblesPanel;
